...
public class OfflineGameSetupUI extends JFrame implements ActionListener, ItemListener {
	...
	private OfflineGameSetup gameSetup;
	...
	public OfflineGameSetupUI(OfflineGameSetup gameSetup) {
		super(TITLE);
		this.gameSetup = gameSetup;	
		buildGUI();
		addWindowListener(new WindowAdapter() {
			public void windowClosing(WindowEvent e) {
				((OfflineGameSetupUI) e.getWindow()).close();
			}
		});
		setUp(2);	
	}
	...
	public static void main(String[] args) {
		OfflineGameSetupUI ui = new OfflineGameSetupUI(new OfflineGameSetup(new Main()));
		ui.setVisible(true);
	}
